...
- `../skills/visual-explainer/references/libraries.md` (Mermaid theming JS, font imports)
- `../skills/visual-explainer/templates/architecture.html` (reference template for CSS Grid card layouts)
...
Write to the current feature directory under `docs/features/` if one exists. Otherwise create `docs/features/<YYYYMMDD-HHMM>-<slug>/`. Open in browser. Tell the user the file path.
