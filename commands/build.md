...
2. **PRD** — synthesize a PRD from the grilling outcome, propose public-interface test surfaces, iterate through annotation cycles until approved
3. **Tasks** — break the PRD into vertical-slice tracer bullets (HITL/AFK) that carry those test surfaces forward, quiz the user until approved
