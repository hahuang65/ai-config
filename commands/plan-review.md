...
5. **Change-by-change breakdown** — for each change in the plan, a side-by-side panel. Apply overflow prevention per core.md.
...
Include responsive section navigation. Use a current-vs-planned visual language throughout: blue/neutral for current state, green/purple for planned additions, amber for areas of concern, red for gaps or risks. Follow output and AI illustration rules from core.md.
