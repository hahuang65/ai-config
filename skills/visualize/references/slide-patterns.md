...
**When to use slides:** Only when the user explicitly requests them — the `--slides` flag on an existing prompt, or natural language like "as a slide deck." Never auto-select slide format.
