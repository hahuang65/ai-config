...
Comply with the project rules already loaded in context (coding-style, testing, security, performance, git-workflow). Testing decisions must follow the testing rules. Implementation decisions must respect security and performance rules.
