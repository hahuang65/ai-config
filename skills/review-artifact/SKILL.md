...
```text
node <skill-directory>/bin/review-artifact.mjs <html-file>
...
1. Confirm the input is an existing HTML artifact that is asking for feedback, a decision, or approval.
2. Open it with the runtime.
