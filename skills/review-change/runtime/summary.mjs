import { sanitizeTelemetryLine, sanitizeTerminalLine } from "./terminal-text.mjs";
...
export function renderTerminalSummary({ exitCode, target, intent, scope, report, fullLog, findings, risk, stages }) {
  ...
  if (fullLog) lines.push(`Full log: ${sanitizeTelemetryLine(fullLog)}`);
