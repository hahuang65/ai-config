...
Run the smallest relevant focused checks that can substantiate Authoritative intent, never a full repository suite during Review change; missing evidence becomes an `ask-user` warning rather than a claim of success.
