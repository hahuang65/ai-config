...
Label that result as prior broad Validation evidence in the final report and never rerun it during Change review.
...
The Change review report is the existing fourth `/build` gate.
