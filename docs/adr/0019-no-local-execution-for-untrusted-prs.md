...
Standalone Change reviews therefore use static analysis and provider CI evidence for remote pull requests unless the user explicitly marks the change trusted or the project supplies a documented sandbox.
