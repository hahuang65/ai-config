...
We replaced mandatory build-time `review-code` with `review-change` and retained its architectural analysis and grilling behavior as an optional standalone workflow.
