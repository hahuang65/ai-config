...
Change review isolation is operational rather than development work and uses `~/.review-treehouse/` instead, as recorded in ADR 0022.
...
- Disposable Change review worktrees cannot be mistaken for active development worktrees.
