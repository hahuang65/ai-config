...
`docs/features/20260312-1332-readme/research.md`
...
2. **Feature directory layout**: The `docs/features/<timestamp>-<slug>/` tree showing all 5 artifacts.
...
├── docs/features/      Feature artifacts (research, plans, visuals)
...
5. **Single file**: Everything in one `README.md` rather than splitting into `docs/`. The repo already has `docs/features/` for feature artifacts — a separate docs structure would create confusion about what goes where.
