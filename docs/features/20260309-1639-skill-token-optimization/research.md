...
- **"Write to docs/features/... Open in browser"** — appears in: ALL visual commands (6 times, ~150 chars each)
...
8. **Deduplicate "Write to docs/features/" instructions** — This appears in every command but is only ~150 chars each. Not worth extracting.
