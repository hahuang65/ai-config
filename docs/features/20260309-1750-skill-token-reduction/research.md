...
The prior research at `docs/features/20260309-1639-skill-token-optimization/` focused on the VE SKILL.md reload problem and produced the core.md solution. That optimization was implemented and saved ~307K chars (~45%) per `/build-feature` run.
