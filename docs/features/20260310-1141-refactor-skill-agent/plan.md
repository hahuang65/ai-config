...
`docs/features/20260310-1141-refactor-skill-agent/research.md`
...
- **No persistent artifacts.** Unlike `/research` and `/plan`, this skill doesn't produce markdown documents in `docs/features/`. Refactoring is a focused operation — results are the transformed code itself.
